...
app.use("/", require("./views/route/index"));
app.use("/aff", require("./views/route/Affirmation"));
app.use("/pod", require("./views/route/Podcasts"));
app.use("/med", require("./views/route/meditation"));
app.use("/log", require("./views/route/signin"));
app.use("/reg", require("./views/route/signup"));
